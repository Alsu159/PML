...
# Стилизация окна диалога
style window:
    xalign 0.5
    xfill True
    yalign gui.textbox_yalign
    ysize gui.textbox_height
    background Frame("gui/texbox_gothic.png", xalign=0.5, yalign=1.0)

# Стилизация рамки имени
style namebox:
    xpos gui.name_xpos
    ...
    background Frame("gui/namebox_gothic.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
style say_label:
    ...
    yalign 0.5
    color "#ebca75"  # Золотистый оттенок
    outlines [ (1, "#2e2e2e", 0, 0) ]  # Лёгкая тень
...
screen choice(items):
    ...
    # Используем то же окно, что и для диалогов
    window:
        id "window"  # Это даёт ему поведение как у обычного окна
        xalign 0.5
        yalign 0.95
        ...
        vbox:
            ...
            for i in items:
                button:
                    xmaximum 420
                    xminimum 420  # одинаковая ширина
                    background Frame("gui/overlay/choice_button.png")
                    padding (20, 10)  # регулирует отступы внутри кнопки
                    action i.action
                    xalign 0.5
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        fixed:
            ...
            imagebutton:
                idle "gui/mainmenu/settings_icon.png"
                hover "gui/mainmenu/settings_icon_hover.png"
                action ShowMenu("statistic")#("preferences")
                xpos 570
                ypos 20
                at alpha_during_hover

            imagebutton:
                idle "gui/mainmenu/exit_icon.png"
                hover "gui/mainmenu/exit_icon_hover.png"
                action MainMenu(confirm=True)
                xpos 20
                ypos 20
                at alpha_during_hover

transform alpha_during_hover:
    on idle:
        alpha 0.1
    on hover:
        alpha 1.0               
...
screen main_menu():
    ...
    imagebutton:
        idle "gui/mainmenu/play_button.png"
        if persistent.chapter_passed == 0:
            action Start()
        elif persistent.chapter_passed == 1:
            action Start("start_chapter_2")
        else:
            action Confirm("Других серий нет :(", NullAction())
        xpos 116
        ypos 350

    imagebutton:
        idle "gui/mainmenu/restart_button.png"
        action Start("restart_chapters")
        xpos 116
        ypos 550

    imagebutton:
        idle "gui/mainmenu/stats_button.png"
        action ShowMenu("statistic")
        xpos 116
        ypos 750
    ...
    imagebutton:
        idle "gui/mainmenu/about_icon.png"
...
screen about():
    ...
    imagebutton:
        idle "gui/overlay/back_icon.png"
        hover "gui/overlay/back_icon.png"
        action Return()
        xpos 20
        ypos 1130
...
style about_title is gui_text:
    size 48
    color "#d4b873"
    bold True
    xalign 0.5
    outlines [ (2, "#1e1e1e", 0, 0) ]
...
screen preferences():
    ...
    add "gui/preferences/background.png"  

    fixed:

        imagebutton:
            idle "gui/preferences/back_idle.png"
            hover "gui/preferences/back_hover.png"
            action Return()
            xpos 20
            ypos 1130

        imagebutton:
            idle "gui/preferences/mute_idle.png"
            # hover "gui/preferences/mute_hover.png"
        ...
        vbox:
            ...
            vbox:
                ...
                text "Музыка" style "pref_label_text"
            ...
            vbox:
                ...
                text "Звуки" style "pref_label_text"
...
style pref_label_text:
    color "#f1b742" 
    font "gui/fonts/YourGothicFont.ttf"
    size 50
    bold True
...
style pref_bar:
    ...
    xsize 467
    ysize 100
    base_bar Frame("gui/preferences/bar_full.png")
    thumb VBox(
        Null(height=25),
        "gui/preferences/thumb.png",
        Null(height=25),
    )
    thumb_offset 28
    left_gutter 55
...
screen confirm(message, yes_action, no_action):
    ...
    frame:
        background Frame("gui/overlay/confirm_bg.png", 25, 25, 25, 25)  # растягиваемый фон
        padding (50, 40)
        xalign 0.5
        yalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                imagebutton:
                    idle "gui/overlay/button_yes.png"
                    action yes_action
                    xysize (130, 66)

                imagebutton:
                    idle "gui/overlay/button_no.png"
                    action no_action
                    xysize (130, 66)
